...
- `CLAUDE.md` dosyasındaki `I Love You Animasyonlu PWA`, `I Love You Animasyonlu PWA — Premium SaaS Uygulaması`, `[TECH_STACK]` gibi alanları gerçek değerlerle değiştir
